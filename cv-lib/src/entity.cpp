...
const EntityType Location::get_entity_type(void) const {
...
const EntityType Edge::get_entity_type(void) const {
...
const EntityType Area::get_entity_type(void) const {
...
const EntityType Circle::get_entity_type(void) const {
...
const EntityType Grid::get_entity_type(void) const {
