...
class CSVInputFactory
{
    public:
        ...
        const std::vector<geo::EdgeCPtr>& get_implicit_edges(void) const;

        const std::vector<trajectory::IntervalCPtr>& get_critical_intervals(void) const;

        const std::vector<trajectory::IntervalCPtr>& get_privacy_intervals(void) const;
        ...
        void make_implicit_edge(const StrVector& line_parts); 
        void make_critical_interval(const StrVector& line_parts);
        void make_privacy_interval(const StrVector& line_parts);
    ...
    private:
        ...
        geo::Vertex::IdToPtrMap implicit_edge_map_;
        ...
        std::vector<geo::EdgeCPtr> implicit_edges_;
        std::vector<trajectory::IntervalCPtr> critical_intervals_;
        std::vector<trajectory::IntervalCPtr> privacy_intervals_;
};
...
class CSVOutputFactory
{
    public:
        ...
        void add_implicit_edge(geo::EdgeCPtr implicit_ptr);

        void add_critical_interval(trajectory::IntervalCPtr critical_interval_ptr);

        void add_privacy_interval(trajectory::IntervalCPtr privacy_interval_ptr);
        ...
        void write_implicit_edge(std::ofstream& os, geo::EdgeCPtr edge_ptr) const; 

        void write_critical_interval(std::ofstream& os, trajectory::IntervalCPtr critical_interval_ptr) const; 
    
        void write_privacy_interval(std::ofstream& os, trajectory::IntervalCPtr privacy_interval_ptr) const; 
