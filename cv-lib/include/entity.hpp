...
/**
 * @brief An enumeration of all the entity types. These are used to quickly check abstract entity types.
 */
...
class Entity {
    public:
        ...
        /**
         * @brief Get an enum identifier for this entity.
         * 
         * @return Entity The enum type of this entity.
         */ 
        virtual const EntityType get_entity_type(void) const = 0;
...
class Location : public Point, public Entity {
    public:
         ...
         * @return Entity The enum type of this entity.
         */ 
        const EntityType get_entity_type(void) const;
